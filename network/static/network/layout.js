...
//    let writer = document.querySelector('#myemail').dataset.user.email;
    let writer = document.querySelector('#myemail').dataset.user.email;
    Email.send({
        Host: "smtp.elasticemail.com",
        Username: "bhutyaksh@gmail.com",
        Password: "0C42031B7009851D4B82AD02F61E16215ACB",
        To: writer,
        From: 'bhutyaksh@gmail.com',
        Subject: "This is the subject",
        Body: writer
    }).then(
        message => alert(writer)
    );
}
...
function send(ele,b,c){
    //    let writer = document.querySelector('#myemail').dataset.user.email;
        // let writer = document.querySelector('#myemail').dataset.user.email;
            ...
            From: 'bhutyaksh@gmail.com',
            Subject: "This is the subject",
            Body: ele+ " commented on your post" + " with post id" + c
        })
        

    }
function write_comment(element,a,b,c) {
    // alert(b);
    send(a,b,c);
