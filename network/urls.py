...
urlpatterns = [
    ...
    path("n/new", views.new, name="new"),
    path("n/login", views.login_view, name="login"),
    path("n/sregister", views.sregister, name="sregister"),
    path("n/logout", views.logout_view, name="logout"),
    path("n/saveedit", views.saveedit, name="saveedit"),
    path("n/edit/<str:username>", views.edit, name="edit"),
    path("n/report/<int:id>", views.report, name="report"),
